  ...
  useEffect(() => {
    ...
    return () => {
      if (editorInstance.current) {
        if (typeof editorInstance.current.toTextArea === 'function') {
          editorInstance.current.toTextArea();
        } else if (editorInstance.current.getWrapperElement) {
          const wrapper = editorInstance.current.getWrapperElement();
